      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-6 relative">
        ...
        <div class="dark:text-white col-span-2">
          ...
          <ol class="parent" :class="{ 'not-loading': !experienceStore.loading }">
            ...
            <li v-else class="mb-5 ms-6" v-for="(experience, index) in experienceStore.experiences" :key="index">
...
<style scoped>
  ...
  .parent.not-loading {
    @apply relative border-s ml-2 border-gray-400 dark:border-zinc-800;
  }
