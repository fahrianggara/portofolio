            ...
            <div class="contact-box lg:col-span-2 md:col-span-3 sm:col-span-full col-span-1">
              ...
              <form class="contact-form" autocomplete="off">
                <div class="grid grid-cols-1 gap-3 ">
                  ...
                  <div>
                    <input type="text" id="subject" name="subject" placeholder="What's the subject?" />
                  </div>
                  <div>
                    <textarea id="message" name="message" placeholder="Please write your message here..."
                    rows="3" class="is-invalid"></textarea>
                    <p class="text-red-500 text-[13px] my-1">This field is required</p>
                  </div>
                  <div>
                    <button type="submit" >
                      Send Message
